...
export default function WeExportWorldwide() {
  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-[85vh] relative w-full bg-gradient-to-r from-white to-blue-50 dark:from-black dark:to-blue-950">
