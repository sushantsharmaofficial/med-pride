...
export function NotFoundPage() {
  ...
  return (
    <section className="bg-white dark:bg-black font-serif min-h-screen flex items-center justify-center">
        ...
        <div className="flex justify-center">
          <div className="w-full sm:w-10/12 md:w-8/12 text-center">
            <div
              ...
              aria-hidden="true"
            >
              <h1 className="text-center text-black dark:text-white text-6xl sm:text-7xl md:text-8xl pt-6 sm:pt-8">
                404
              </h1>
            </div>
            ...
            <div className="mt-[-50px]">
              ...
              <p className="mb-6 text-black dark:text-white sm:mb-5">
