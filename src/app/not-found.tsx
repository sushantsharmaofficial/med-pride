...
// Used when users navigate to non-existent routes
...
export default function NotFoundPage() {
  ...
  return (
    <section className="bg-white  font-primary min-h-screen flex items-center justify-center">
        ...
        <div className="flex justify-center">
          <div className="w-full sm:w-10/12 md:w-8/12 text-center">
            <div
              ...
              aria-hidden="true"
            >
              <h1 className="text-center text-black  text-6xl sm:text-7xl md:text-8xl pt-2">
                404
              </h1>
            </div>
